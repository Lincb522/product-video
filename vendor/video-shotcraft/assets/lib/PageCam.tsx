...
export const PageCam: React.FC<{
    ...
    if (!has3D) {
        return (<PvElement as={AbsoluteFill} style={{ overflow: 'hidden', backgroundColor: '#faf7f2' }}>
        <PvElement as={"div"} style={{
          ...
          <PvElement as={Img} src={staticFile(src)} style={{ position: 'absolute', width: 1920, height: pageH }}/>
          {children}
        </PvElement>
      </PvElement>);
    }
