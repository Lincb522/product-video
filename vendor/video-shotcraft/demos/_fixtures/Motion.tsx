...
export const seg = (t: number, t0: number, t1: number, ease: (x: number) => number = E.linear) => ease(Math.min(1, Math.max(0, (t - t0) / (t1 - t0))));
...
export const DesignStage: React.FC<{
    ...
    const scale = width / w;
    return (<PvElement as={AbsoluteFill} style={{ background: bg ?? '#000', overflow: 'hidden' }}>
