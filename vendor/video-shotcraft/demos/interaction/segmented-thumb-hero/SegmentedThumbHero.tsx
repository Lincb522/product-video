...
const ArrowCursor: React.FC<{
    ...
    y: number;
    press: number;
}> = ({ x, y, press }) => (<PvElement as={"svg"} width={130} height={150} viewBox="0 0 26 30" style={{
        position: 'absolute',
        left: x,
        top: y,
    ...
    <PvElement as={"path"} d="M4 2 L4 24 L9.5 18.5 L13 27 L16.8 25.4 L13.3 17 L21 17 Z" fill="#fff" stroke={G.ink} strokeWidth={1.8} strokeLinejoin="round"/>
  </PvElement>);
const SmileLaptop: React.FC<{
    size: number;
}> = ({ size }) => (<PvElement as={"svg"} width={size} height={size} viewBox="0 0 40 40">
    <PvElement as={"rect"} x={7} y={7} width={26} height={19} rx={3} fill="none" stroke={G.ink} strokeWidth={3}/>
    <PvElement as={"circle"} cx={15.5} cy={14.5} r={1.9} fill={G.ink}/>
    <PvElement as={"circle"} cx={24.5} cy={14.5} r={1.9} fill={G.ink}/>
    <PvElement as={"path"} d="M14.5 19 Q20 23.5 25.5 19" stroke={G.ink} strokeWidth={2.6} fill="none" strokeLinecap="round"/>
    <PvElement as={"path"} d="M4 31 L36 31" stroke={G.ink} strokeWidth={3.4} strokeLinecap="round"/>
  </PvElement>);
const AskIcon: React.FC<{
    size: number;
}> = ({ size }) => (<PvElement as={"svg"} width={size} height={size} viewBox="0 0 40 40">
    <PvElement as={"circle"} cx={20} cy={20} r={13} fill="none" stroke={G.ink} strokeWidth={3}/>
    <PvElement as={"path"} d="M16 17 q0-5 4.5-5 q4.5 0 4.5 4.2 q0 3-3.4 4.4 q-1.6 0.7-1.6 2.6" stroke={G.ink} strokeWidth={2.8} fill="none" strokeLinecap="round"/>
    <PvElement as={"circle"} cx={20} cy={28} r={1.8} fill={G.ink}/>
  </PvElement>);
export const SegmentedThumbHero: React.FC = () => {
    ...
    return (<PvElement as={AbsoluteFill} style={{ background: G.bg, alignItems: 'center', justifyContent: 'center' }}>
      ...
      <PvElement as={"div"} style={{
        ...
        {/* 点击涟漪 */}
        {rippleT > 0 && rippleT < 1 && (<PvElement as={"div"} style={{
                position: 'absolute',
        ...
        {/* Ask 段 */}
        <PvElement as={"div"} style={labelStyle(askActive)}>
