...
const envelope = (t: number) => {
    const seg = (a: number, b: number, rise = 5, fall = 7) => interpolate(t, [a, a + rise, b - fall, b], [0, 1, 1, 0], {
...
export const VoiceWaveformLive: React.FC = () => {
    ...
    const bars = Array.from(pvArrayCopy({ length: N_BARS })).map((_, i) => {
    ...
    return (<PvElement as={AbsoluteFill} style={{ background: '#08080a', overflow: 'hidden' }}>
      {/* 暗场绸缎底光 */}
      ...
      <PvElement as={AbsoluteFill} style={{ alignItems: 'center', justifyContent: 'center' }}>
        <PvElement as={"div"} style={{
          ...
          <PvElement as={"div"} style={{
            ...
            gap: 6, overflow: 'hidden',
              ...
              {bars.map((h, i) => (<PvElement as={"div"} key={i} style={{
            ...
            boxShadow: submitted
              ...
              <PvElement as={"svg"} width="44" height="44" viewBox="0 0 24 24">
                <PvElement as={"path"} d="M12 20V5M12 5l-6.5 6.5M12 5l6.5 6.5" stroke="#111114" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
              </PvElement>
            </PvElement>
          </PvElement>
        </PvElement>
