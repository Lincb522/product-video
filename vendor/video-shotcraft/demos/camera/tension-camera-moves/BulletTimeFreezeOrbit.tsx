...
export const BulletTimeFreezeOrbit: React.FC = () => {
    ...
    const bars = Array.from(pvArrayCopy({ length: BAR_COUNT })).map((_, i) => {
    ...
    return (<PvElement as={"div"} style={{
      ...
      <PvElement as={"div"} style={{ position: 'absolute', top: 56, left: 72 }}>
      ...
      <PvElement as={"div"} style={{
        ...
        <PvElement as={"div"} style={{
          ...
          {/* 图表区:横向刻度线 + 柱子 */}
          <PvElement as={"div"} style={{ position: 'relative', width: chartW, height: chartH }}>
            ...
            {bars.map((b, i) => (<PvElement as={"div"} key={i}>
                <PvElement as={"div"} style={{
                position: 'absolute',
                left: i * (barW + gap),
                bottom: 3,
