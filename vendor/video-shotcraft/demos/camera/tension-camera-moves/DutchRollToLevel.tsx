    ...
    return (<PvElement as={AbsoluteFill} style={{ background: G.bg, overflow: 'hidden' }}>
      <PvElement as={"div"} style={{
        ...
        <PvElement as={"div"} style={{
          ...
          <PvElement as={"div"} style={{ height: 16, width: 420, background: G.mid, borderRadius: 8 }}/>
        </PvElement>

        {/* 解决方案：干净卡随滚正浮现在同一位置 */}
        <PvElement as={"div"} style={{ position: 'absolute', left: 560, top: 96, opacity: cleanOpacity }}>
