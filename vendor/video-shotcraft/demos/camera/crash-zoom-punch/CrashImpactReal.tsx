...
const Scene: React.FC = () => {
    ...
    return (<PvElement as={AbsoluteFill} style={{ backgroundColor: '#f9f6f1', overflow: 'hidden' }}>
      <PvElement as={"div"} style={{
        ...
        <PvElement as={Img} src={staticFile('textures/live/projects-full.png')} style={{ position: 'absolute', width: 1920 }}/>
...
export const CrashImpactReal: React.FC = () => {
    ...
    return frame >= 38 && frame <= HIT ? (<CameraMotionBlur shutterAngle={200} samples={20}>
      <Scene />
