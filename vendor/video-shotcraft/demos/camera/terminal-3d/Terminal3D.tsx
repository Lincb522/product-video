          ...
          <PvElement as={"div"} style={{
            ...
            return (<PvElement as={"div"} key={i} style={{
                  ...
                  <PvElement as={"div"} style={{
                    ...
                    {['#ff6058', '#ffbd2e', '#28ca42'].map((c, k) => (<PvElement as={"div"} key={c} style={{
                  ...
                  <PvElement as={"div"} style={{
                    ...
                    {Array.from(pvArrayCopy(d.cmd), (ch, c) => (
                // 空格换成 nbsp，对齐 effect.js 的 textContent 处理
                <PvElement as={"span"} key={c} style={{ opacity: c < n ? 1 : 0 }}>{ch === ' ' ? ' ' : ch}</PvElement>))}
