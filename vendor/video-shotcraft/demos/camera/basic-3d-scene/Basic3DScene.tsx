        ...
        <PvElement as={"div"} style={{
          ...
          {POSES.map((p, i) => {
            ...
            return (<PvElement as={"div"} key={i} style={{
                ...
                <PvElement as={"div"} style={{ fontSize: 11, letterSpacing: 3, color: `hsl(${p.hue},80%,68%)`, fontWeight: 700 }}>
                  {p.tt}
                </PvElement>
                <PvElement as={"div"} style={{ fontSize: last ? 26 : 21, fontWeight: 800, marginTop: 8 }}>{p.sub}</PvElement>
                <PvElement as={"div"} style={{ marginTop: 12, height: 5, width: '56%', borderRadius: 3, background: `hsl(${p.hue},70%,45%)` }}/>
                <PvElement as={"div"} style={{ marginTop: 7, height: 5, width: '34%', borderRadius: 3, background: `hsla(${p.hue},50%,60%,.4)` }}/>
              </PvElement>);
        })}
        </PvElement>
      </PvElement>
