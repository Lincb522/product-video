...
export const LineUnfoldPanel: React.FC = () => {
    ...
    return (<PvElement as={"div"} style={{ width: 1920, height: 1080, background: '#1c1c1b', overflow: 'hidden', position: 'relative' }}>
      ...
      {alive && (<PvElement as={"div"} style={{
          ...
          {isPanel ? (<>
            ...
            <PvElement as={"div"} style={{ width: '100%', height: '100%', background: '#ffffff', boxShadow: '0 0 60px rgba(255,255,255,0.9)', borderRadius: 2 }}/>)}
        </PvElement>)}
    </PvElement>);
};
