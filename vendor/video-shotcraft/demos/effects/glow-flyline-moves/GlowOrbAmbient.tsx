...
export const GlowOrbAmbient: React.FC = () => {
    ...
    return (<PvElement as={AbsoluteFill} style={{ background: '#1d1d1b', overflow: 'hidden' }}>
      {ORBS.map((o, i) => (<PvElement as={"div"} key={i} style={{
                position: 'absolute',
      ...
      <PvElement as={"div"} style={{
        ...
        <PvElement as={"div"} style={{ height: 18, width: '55%', background: '#4a4a48', borderRadius: 9 }}/>
        <PvElement as={"div"} style={{ height: 11, width: '82%', background: '#3a3a38', borderRadius: 6 }}/>
        <PvElement as={"div"} style={{ height: 11, width: '68%', background: '#3a3a38', borderRadius: 6 }}/>
        <PvElement as={"div"} style={{ marginTop: 'auto', display: 'flex', gap: 10, alignItems: 'center' }}>
          <PvElement as={"div"} style={{ width: 28, height: 28, borderRadius: 14, background: '#4a4a48' }}/>
          <PvElement as={"div"} style={{ height: 11, width: 90, background: '#3a3a38', borderRadius: 6 }}/>
        </PvElement>
      </PvElement>
    </PvElement>);
};
