...
export const ScanBracketSweep: React.FC = () => {
    ...
    return (<DesignStage bg={BG}>
      ...
      <PvElement as={"div"} style={{
        ...
        <PvElement as={"div"} style={{ position: 'absolute', left: DX, top: DY, width: DW, height: DH }}>
          ...
          <PvElement as={"div"} style={{
            ...
            <PvElement as={"div"} style={{ position: 'absolute', left: 0, top: 0, right: 0 }}>
              {/* 标题条 + 副标题条 */}
              <PvElement as={"div"} style={{
            position: 'absolute',
            left: 14,
            ...
            background: SKEL,
              ...
              {/* 4 列骨架：列头 + 7 行随机宽占位条 */}
              {SKEL_COLS.map((col, c) => (<React.Fragment key={c}>
                  <PvElement as={"div"} style={{
                position: 'absolute',
                left: col.x,
                top: 44,
                ...
                background: '#9A9AA2',
                  ...
                  {col.rows.map((row, r) => (<PvElement as={"div"} key={r} style={{
                    position: 'absolute',
                    left: col.x,
                    top: row.top,
                    width: row.w,
