...
export const RadialRipplePhoneChips: React.FC = () => {
    ...
    return (<DesignStage bg="#f2f3f5">
      <PvElement as={"div"} style={{ position: 'absolute', inset: 0, background: '#f2f3f5', overflow: 'hidden' }}>
        {/* 同心圆各层错相极缓呼吸 */}
        {RINGS.map(({ size, color, phase }, i) => (<PvElement as={"div"} key={i} style={{
                position: 'absolute',
                left: '50%',
                top: '50%',
                width: size,
        ...
        <PvElement as={"div"} style={{
          ...
          <PvElement as={"div"} style={{ position: 'relative', width: '100%', height: '100%', borderRadius: 16, background: '#fff', overflow: 'hidden' }}>
            <PvElement as={"div"} style={{
            position: 'absolute',
            left: 0,
            top: 0,
            ...
            transform: `translateY(${-seg(t, 0.08, 0.98) * 150}px)`,
              ...
              {CARDS.map(({ imgGrad, l1w, l2w }, i) => (<PvElement as={"div"} key={i} style={{ position: 'relative', margin: '8px 8px 0', padding: 7, borderRadius: 8, background: '#f4f4f7' }}>
                  <PvElement as={"div"} style={{ height: 34, borderRadius: 5, background: imgGrad }}/>
                  <PvElement as={"div"} style={{ marginTop: 6, height: 5, width: l1w, borderRadius: 3, background: '#c9cad3' }}/>
                  <PvElement as={"div"} style={{ marginTop: 4, height: 5, width: l2w, borderRadius: 3, background: '#dedfe6' }}/>
                </PvElement>))}
            </PvElement>
          </PvElement>
        </PvElement>
        ...
        <PvElement as={"div"} style={{ ...chipBase, top: '38%', right: 'calc(50% + 86px)', ...chipStyle(0.22, 0) }}>Feature one</PvElement>
        <PvElement as={"div"} style={{ ...chipBase, top: '56%', left: 'calc(50% + 86px)', ...chipStyle(0.4, 1.8) }}>Feature detail</PvElement>
      </PvElement>
    </DesignStage>);
};
