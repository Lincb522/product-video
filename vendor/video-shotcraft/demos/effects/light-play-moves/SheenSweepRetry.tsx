...
export const SheenSweepRetry: React.FC = () => {
    ...
    return (<PvElement as={"div"} style={{
      ...
      <PvElement as={"div"} style={{
        ...
        <PvElement as={"div"} style={{ height: 16, width: 380, background: G.sideBar, borderRadius: 8 }}/>
        <PvElement as={"div"} style={{ height: 16, width: 260, background: G.sideBar, borderRadius: 8 }}/>

        {/* 高光带：条件挂载，扫完即摘罩，收尾真静止 */}
        {sweepActive && (<PvElement as={"div"} style={{
                position: 'absolute',
                top: 0,
                left: 0,
                width: SHEEN_W,
