...
const CornerTag: React.FC<{
    text: string;
    opacity: number;
}> = ({ text, opacity }) => (<PvElement as={"div"} style={{
        position: 'absolute',
        right: 72,
        bottom: 56,
        padding: '10px 22px',
...
export const LineBoil: React.FC = () => {
    ...
    return (<PvElement as={"div"} style={{ width: 1920, height: 1080, background: G.bg, position: 'relative', overflow: 'hidden' }}>
      ...
      {boiling && (<PvElement as={"svg"} width={0} height={0} style={{ position: 'absolute' }}>
          <PvElement as={"defs"}>
            <PvElement as={"filter"} id={boilId} x="-15%" y="-15%" width="130%" height="130%">
              <PvElement as={"feTurbulence"} type="fractalNoise" baseFrequency={0.015} numOctaves={2} seed={seed} result="noise"/>
              <PvElement as={"feDisplacementMap"} in="SourceGraphic" in2="noise" scale={BOIL_SCALE} xChannelSelector="R" yChannelSelector="G"/>
            </PvElement>
          </PvElement>
        </PvElement>)}
      ...
      <PvElement as={"div"} style={{
        ...
        <PvElement as={"div"} style={{
          ...
          <PvElement as={"div"} style={{ height: 16, width: '62%', background: G.mid, borderRadius: 8 }}/>
          <PvElement as={"div"} style={{ height: 12, width: '88%', background: G.bar, borderRadius: 6 }}/>
          <PvElement as={"div"} style={{ height: 12, width: '74%', background: G.bar, borderRadius: 6 }}/>
          <PvElement as={"div"} style={{ height: 12, width: '81%', background: G.bar, borderRadius: 6 }}/>
          <PvElement as={"div"} style={{ marginTop: 'auto', display: 'flex', gap: 12, alignItems: 'center' }}>
            <PvElement as={"div"} style={{ width: 30, height: 30, borderRadius: 15, border: `3px solid ${G.ink}`, boxSizing: 'border-box' }}/>
            <PvElement as={"div"} style={{ height: 12, width: 120, background: G.mid, borderRadius: 6 }}/>
          </PvElement>
        </PvElement>
      </PvElement>
