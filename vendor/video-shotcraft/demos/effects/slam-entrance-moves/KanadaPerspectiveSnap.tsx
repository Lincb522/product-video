...
export const KanadaPerspectiveSnap: React.FC = () => {
    ...
    return (<PvElement as={"div"} style={{ width: 1920, height: 1080, background: G.bg, position: 'relative', overflow: 'hidden' }}>
      <PvElement as={"div"} style={{ position: 'absolute', left: shakeX, top: shakeY, width: 1920, height: 1080 }}>
        ...
        <PvElement as={"div"} style={{ position: 'absolute', left: CX, top: CY, perspective: `${persp}px`, perspectiveOrigin: '30% 50%' }}>
          <PvElement as={"div"} style={{
