...
export const TextAsMask: React.FC = () => {
    ...
    return (<PvElement as={"div"} style={{ width: 1920, height: 1080, background: G.ink, position: 'relative', overflow: 'hidden' }}>
      ...
      <PvElement as={"div"} style={{
        ...
        <PvElement as={"div"} style={{ position: 'absolute', inset: 0, transform: `scale(${1 / maskS})`, transformOrigin: ORIGIN }}>
          <PvElement as={"div"} style={dashMotion}>
      ...
      <PvElement as={"div"} style={{ position: 'absolute', inset: 0, opacity: cover }}>
        <PvElement as={"div"} style={dashMotion}>
          <FakeDashboard variant="A"/>
        </PvElement>
      </PvElement>
