...
// 卡片正面：灰阶海报卡
const CardFace: React.FC = () => (<PvElement as={"div"} style={{
    ...
    <PvElement as={"div"} style={{ height: 26, width: '62%', background: G.bar, borderRadius: 13 }}/>
    <PvElement as={"div"} style={{ height: 12, width: '84%', background: G.line, borderRadius: 6 }}/>
    <PvElement as={"div"} style={{
        flex: 1, borderRadius: 14, background: `linear-gradient(145deg, #e6e6e4, ${G.bar})`,
        display: 'flex', alignItems: 'center', justifyContent: 'center',
    }}>
      <PvElement as={"div"} style={{ width: 110, height: 110, borderRadius: 55, background: G.mid, opacity: 0.55 }}/>
    </PvElement>
    <PvElement as={"div"} style={{ height: 12, width: '74%', background: G.line, borderRadius: 6 }}/>
    <PvElement as={"div"} style={{ height: 12, width: '52%', background: G.line, borderRadius: 6 }}/>
    <PvElement as={"div"} style={{ display: 'flex', alignItems: 'center', gap: 10, marginTop: 4 }}>
      <PvElement as={"div"} style={{ width: 34, height: 34, borderRadius: 17, background: G.mid }}/>
      <PvElement as={"div"} style={{ height: 11, width: 90, background: G.line, borderRadius: 5 }}/>
      <PvElement as={"div"} style={{ marginLeft: 'auto', width: 58, height: 24, borderRadius: 12, background: G.ink, opacity: 0.75 }}/>
    </PvElement>
  </PvElement>);
// 卡背：深灰斜纹
const CardBack: React.FC = () => (<PvElement as={"div"} style={{
    ...
    <PvElement as={"div"} style={{
      ...
      <PvElement as={"div"} style={{ width: 72, height: 72, borderRadius: 36, border: '3px solid rgba(255,255,255,0.22)' }}/>
    </PvElement>
  </PvElement>);
...
const SpawnFlash: React.FC<{
    ...
    const needle = (deg: number, len: number, w0: number, op: number) => (<PvElement as={"g"} key={`${deg}-${len}`} transform={`rotate(${deg})`} opacity={op}>
      <PvElement as={"path"} d={`M 0 ${-w0 / 2} L ${len} 0 L 0 ${w0 / 2} Z`} fill={`url(#${SPIKE_ID})`}/>
      <PvElement as={"path"} d={`M 0 ${-w0 / 2} L ${len} 0 L 0 ${w0 / 2} Z`} fill={`url(#${SPIKE_ID})`} transform="scale(-1,1)"/>
    </PvElement>);
    return (<PvElement as={"div"} style={{
      ...
      <PvElement as={"svg"} width={260} height={260} viewBox="-130 -130 260 260" style={{
        ...
        {[15, 52, 88, 123, 160, 197, 231, 268, 305, 341].map((deg, i) => {
            ...
            return (<PvElement as={"g"} key={deg} transform={`rotate(${deg})`} opacity={0.75}>
              <PvElement as={"path"} d={`M 8 -1.1 L ${ln} 0 L 8 1.1 Z`} fill="rgba(150,210,255,0.85)" filter="blur(0.8px)"/>
            </PvElement>);
        })}
      </PvElement>
      {/* X 形对角针状星芒——对照 IMG_2505 复刻要点：光束通体明亮饱和
            （青蓝贯穿全长、只在最末端才灭），束身带同色辉光包裹 */}
      <PvElement as={"svg"} width={3200} height={3200} viewBox="-1600 -1600 3200 3200" style={{
            position: 'absolute', left: -1600, top: -1600, transform: `rotate(${rot}deg)`,
        }}>
        <PvElement as={"defs"}>
          {/* v9.6：更纯蓝（参考图光束是饱和蓝，白段只在根部一瞬） */}
          <PvElement as={"linearGradient"} id={SPIKE_ID} x1="0" y1="0" x2="1" y2="0">
            <PvElement as={"stop"} offset="0" stopColor="#eaf6ff" stopOpacity="1"/>
            <PvElement as={"stop"} offset="0.05" stopColor="#8cc8ff" stopOpacity="0.95"/>
            <PvElement as={"stop"} offset="0.3" stopColor="#3f9bff" stopOpacity="0.88"/>
            <PvElement as={"stop"} offset="0.62" stopColor="#2277f2" stopOpacity="0.6"/>
            <PvElement as={"stop"} offset="0.88" stopColor="#1b64e0" stopOpacity="0.25"/>
            <PvElement as={"stop"} offset="1" stopColor="#1a5fd8" stopOpacity="0"/>
          </PvElement>
        </PvElement>
        {/* 长对角轴：辉光包层（宽糊、同色发光）+ 明亮主束 + 过曝细芯 */}
        <PvElement as={"g"} filter="blur(7px)" opacity={0.75}>
          {needle(-38, 826, 26, 1)}
        </PvElement>
        <PvElement as={"g"} filter="blur(1.8px)">
          {needle(-38, 840, 8, 1)}
        </PvElement>
        {needle(-38, 819, 3, 1)}
        {/* 短对角轴：同三层 */}
        <PvElement as={"g"} filter="blur(5px)" opacity={0.75}>
          {needle(52, 413, 20, 1)}
        </PvElement>
        <PvElement as={"g"} filter="blur(1.5px)">
          {needle(52, 420, 6.5, 1)}
        </PvElement>
        {needle(52, 410, 2.6, 1)}
      </PvElement>
...
const Scene: React.FC = () => {
    ...
    return (<PvElement as={"div"} style={{ width: 1920, height: 1080, background: '#000000', position: 'relative', overflow: 'hidden' }}>
      ...
      <PvElement as={"div"} style={{
        ...
        <PvElement as={"div"} style={{
          ...
          <CardFace />
          <PvElement as={"div"} style={{ opacity: facingBack ? 1 : 0, position: 'absolute', inset: 0 }}>
            <CardBack />
          </PvElement>
          ...
          {sheenVisible && (<PvElement as={"div"} style={{
...
const FlashLayer: React.FC = () => {
    const f = useCurrentFrame();
    return (<PvElement as={"div"} style={{ position: 'absolute', inset: 0, overflow: 'hidden', pointerEvents: 'none' }}>
      <SpawnFlash f={f}/>
    </PvElement>);
};
