...
export const GridWaveFlip: React.FC = () => {
    ...
    return (<PvElement as={AbsoluteFill} style={{
      ...
      <PvElement as={"div"} style={{
        ...
        {Array.from(pvArrayCopy({ length: ROWS * COLS })).map((_, i) => {
            ...
            return (<PvElement as={"div"} key={i} style={{ width: CELL_W, height: CELL_H, position: 'relative' }}>
              <PvElement as={"div"} style={{
                    position: 'absolute',
                    inset: 0,
              ...
              {glow > 0.01 && (<PvElement as={"div"} style={{
                        position: 'absolute',
                        left: '4%',
                        width: '92%',
                        top: `${glowTop}%`,
