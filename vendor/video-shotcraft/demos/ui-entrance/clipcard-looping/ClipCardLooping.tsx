...
import { ClipCard } from '@shotcraft-lib/ClipCard';
...
export const ClipCardLooping: React.FC = () => {
    return (<PvElement as={AbsoluteFill} style={{
      ...
      <PvElement as={"div"} style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
        <ClipCard src={CLIP} muted={false} loopDurationInFrames={60} loopCrossfadeInFrames={10} durationInFrames={120} size={200} caption="muted=false · loop" captionSize={11}/>
        {/* 场景 2：startFrom=12 + loop —— 有效步长 60-12=48 */}
        <ClipCard src={CLIP} muted startFrom={12} loopDurationInFrames={60} loopCrossfadeInFrames={10} durationInFrames={120} size={200} caption="startFrom=12 · loop" captionSize={11}/>
      </PvElement>
      ...
      <Sequence name="short-shot" from={0} durationInFrames={120} layout="none">
        <PvElement as={"div"} style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
          <ClipCard src={CLIP} muted loopDurationInFrames={45} loopCrossfadeInFrames={8} durationInFrames={120} size={200} caption="45f clip · 120f shot" captionSize={11}/>
        </PvElement>
      </Sequence>
    </PvElement>);
};
