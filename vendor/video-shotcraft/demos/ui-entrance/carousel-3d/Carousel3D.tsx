      ...
      <PvElement as={"div"} style={{
        ...
        <PvElement as={"div"} style={{
          ...
          <PvElement as={"div"} style={{
            ...
            {Array.from(pvArrayCopy({ length: N }), (_, i) => {
            const hue = 200 + i * 22;
            ...
            const face = (<>
                  <PvElement as={"div"} style={{ fontSize: 24 }}>{ICONS[i]}</PvElement>
                  <PvElement as={"div"} style={{ fontSize: 11, fontWeight: 700, letterSpacing: 1, marginTop: 34 }}>
                    CARD 0{i + 1}
                  </PvElement>
                  <PvElement as={"div"} style={{
                    marginTop: 6,
            ...
            <PvElement as={"div"} key={i} style={{
                  ...
                  <PvElement as={"div"} style={faceStyle}>{face}</PvElement>
                  <PvElement as={"div"} style={{ ...faceStyle, transform: 'rotateY(180deg)' }}>{face}</PvElement>
                </PvElement>);
        })}
          </PvElement>
          {/* 地面反光盘 */}
