...
export const ContactShadowLift: React.FC = () => {
    ...
    return (<PvElement as={"div"} style={{ width: 1920, height: 1080, background: G.bg, position: 'relative', overflow: 'hidden' }}>
      ...
      <PvElement as={"div"} style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 84, background: G.panel, borderBottom: `2px solid ${G.line}`, display: 'flex', alignItems: 'center', padding: '0 48px', gap: 24, boxSizing: 'border-box' }}>
        <PvElement as={"div"} style={{ width: 40, height: 40, borderRadius: 10, background: G.side }}/>
      ...
      {[0, 1, 2].map((i) => {
            ...
            <Card w={CARD_W} h={CARD_H} seed={i + 2} style={{
                    position: 'absolute',
                    left: x,
                    top,
                    boxShadow: 'none',
