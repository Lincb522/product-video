...
export const MorphFromPrimitive: React.FC = () => {
    ...
    const d = morphPath(t);
    return (<PvElement as={"div"} style={{ width: 1920, height: 1080, background: G.bg, position: 'relative' }}>
      <PvElement as={"svg"} width={1920} height={1080} viewBox="0 0 1920 1080" style={{ position: 'absolute', inset: 0 }}>
        <PvElement as={"g"} transform={`translate(${CX} ${CY}) scale(${breath}) translate(${-CX} ${-CY})`}>
          <PvElement as={"path"} d={d} fill="none" stroke={G.ink} strokeWidth={3}/>
        </PvElement>
      </PvElement>
      ...
      <PvElement as={"div"} style={{
        ...
        <PvElement as={"div"} style={{ height: 26, width: '58%', background: G.bar, borderRadius: 13 }}/>
        <PvElement as={"div"} style={{ height: 16, width: '86%', background: G.line, borderRadius: 8 }}/>
        <PvElement as={"div"} style={{ height: 16, width: '72%', background: G.line, borderRadius: 8 }}/>
        <PvElement as={"div"} style={{ marginTop: 'auto', display: 'flex', gap: 14, alignItems: 'center' }}>
          <PvElement as={"div"} style={{ width: 40, height: 40, borderRadius: 20, background: G.mid }}/>
          <PvElement as={"div"} style={{ height: 16, width: 120, background: G.line, borderRadius: 8 }}/>
        </PvElement>
      </PvElement>
    </PvElement>);
};
