...
export const GradientWordSweep: React.FC = () => {
    ...
    const trailMask = `linear-gradient(90deg, transparent 0%, transparent ${Math.max(0, pPct - TRAIL)}%, ` +
    ...
    return (<PvElement as={AbsoluteFill} style={{ background: '#050505', justifyContent: 'center', alignItems: 'center' }}>
      {/* 词后方环境泛光（大半径，随充能增强） */}
      ...
      <PvElement as={"div"} style={{
        ...
        <PvElement as={"div"} style={lineStyle}>
          <PvElement as={"span"} style={{ position: 'relative', display: 'inline-block' }}>
            <PvElement as={"span"}>Supercharged</PvElement>
            {/* AE 式辉光：大半径柔光层（最糊） */}
            ...
            {trailFade > 0.01 && (<PvElement as={"span"} aria-hidden style={{
                ...gradText,
            ...
            {filling && p < 1 && (<PvElement as={"span"} aria-hidden style={{
                position: 'absolute',
                inset: 0,
                color: '#fff',
            ...
            <PvElement as={"svg"} aria-hidden viewBox="0 0 700 240" style={{
            position: 'absolute',
            left: -25,
            top: -62,
            width: 700,
            ...
            return (<PvElement as={"g"} key={`${f.at}-${i}`} opacity={Math.min(1, 1.1 * decay)}>
                    <PvElement as={"path"} d={b.d} fill="none" stroke="rgba(216,60,190,0.65)" strokeWidth={b.long ? 6 : 4.5} strokeLinejoin="miter" style={{ filter: 'blur(6px)' }}/>
                    <PvElement as={"path"} d={b.d} fill="none" stroke="rgba(235,110,215,0.9)" strokeWidth={b.long ? 2.4 : 1.9} strokeLinejoin="miter" style={{ filter: 'blur(1.5px)' }}/>
                    <PvElement as={"path"} d={b.d} fill="none" stroke="#ffd8f2" strokeWidth={b.long ? 1.4 : 1.1} strokeLinejoin="miter"/>
                  </PvElement>);
        })}
            </PvElement>
          </PvElement>{' '}
          <PvElement as={"span"}>performance</PvElement>
        </PvElement>
        <PvElement as={"div"} style={lineStyle}>with rock-solid reliability</PvElement>
      </PvElement>
    </PvElement>);
};
