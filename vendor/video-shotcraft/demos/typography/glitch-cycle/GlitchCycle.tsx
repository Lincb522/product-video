    ...
    return (<DesignStage bg="#0a0b10">
      <PvElement as={"div"} style={{
        ...
        <PvElement as={"div"} style={{
          ...
          {Array.from(pvArrayCopy({ length: MAXCH }), (_, i) => {
            ...
            return (<PvElement as={"span"} key={i} style={{ minWidth: '0.66em', textAlign: 'center', color }}>
                {content}
              </PvElement>);
        })}
        </PvElement>
      ...
      <PvElement as={"div"} style={{
        ...
        <PvElement as={"div"} style={{ height: '100%', width: `${t * 100}%`, background: '#6c8cff' }}/>
      </PvElement>
    </DesignStage>);
};
