...
export const CelFlashStomp: React.FC = () => {
    ...
    return (<PvElement as={"div"} style={{ width: 1920, height: 1080, background: bg, position: 'relative', overflow: 'hidden' }}>
      ...
      <PvElement as={"div"} style={{
        ...
        <PvElement as={"div"} style={{ width: 40, height: 40, borderRadius: 10, background: G.sideBar }}/>
        <PvElement as={"div"} style={{ height: 16, width: 320, background: G.mid, borderRadius: 8 }}/>
        <PvElement as={"div"} style={{ marginLeft: 'auto', height: 16, width: 180, background: G.sideBar, borderRadius: 8 }}/>
      </PvElement>
    </PvElement>);
};
