    ...
    return (<PvElement as={"div"} style={{ width: 1920, height: 1080, background: G.bg, position: 'relative', overflow: 'hidden' }}>
      ...
      <PvElement as={"div"} style={{
        ...
        <PvElement as={"div"} style={{ display: 'flex' }}>
          {chars.map((c, i) => (<PvElement as={"div"} key={i} style={{
        ...
        {/* 基线细线：宽度从 0 生长到全文宽 */}
        <PvElement as={"div"} style={{ width: 920, marginTop: 10, display: 'flex', justifyContent: 'flex-start' }}>
          <PvElement as={"div"} style={{ height: 2, width: `${lineW}%`, background: G.bar }}/>
        </PvElement>
      </PvElement>
    </PvElement>);
};
