...
export const LineCarryTransition: React.FC = () => {
    ...
    return (<PvElement as={AbsoluteFill} style={{ background: G.bg, overflow: 'hidden' }}>
      ...
      <PvElement as={"div"} style={{
        ...
        {/* B 半世界底色略浅，卖出"新世界" */}
        <PvElement as={"div"} style={{ position: 'absolute', left: 1920, top: 0, width: 1920, height: 1080, background: G.panel }}/>

        {/* 场景 A：标题 + 卡 + 进度条轨道（ink 填充即 path 本体） */}
        <PvElement as={"div"} style={{ position: 'absolute', left: 400, top: 250 }}>
          <TitleBlock text="Scene A" size={56}/>
        </PvElement>
        <Card w={560} h={330} seed={2} style={{ position: 'absolute', left: 400, top: 350 }}/>
        <PvElement as={"div"} style={{ position: 'absolute', left: 400, top: 702, width: 560, height: 6, borderRadius: 3, background: G.line }}/>

        {/* 一条线全程 evolve：dasharray/dashoffset 生长 */}
        <PvElement as={"svg"} width={3840} height={1080} style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }}>
          <PvElement as={"path"} d={PATH} fill="none" stroke={G.ink} strokeWidth={6} strokeLinecap="round" strokeLinejoin="round" strokeDasharray={TOTAL} strokeDashoffset={TOTAL - drawn}/>
          {tipMounted && <PvElement as={"circle"} cx={tx} cy={ty} r={11} fill={G.ink} opacity={tipOpacity}/>}
        </PvElement>
        ...
        <PvElement as={"div"} style={{
          ...
          <PvElement as={"div"} style={{ height: 18, width: '58%', background: G.bar, borderRadius: 9 }}/>
          <PvElement as={"div"} style={{ height: 11, width: '86%', background: G.line, borderRadius: 5 }}/>
          <PvElement as={"div"} style={{ height: 11, width: '72%', background: G.line, borderRadius: 5 }}/>
          <PvElement as={"div"} style={{ height: 11, width: '64%', background: G.line, borderRadius: 5 }}/>
          <PvElement as={"div"} style={{ marginTop: 'auto', display: 'flex', gap: 10, alignItems: 'center' }}>
            <PvElement as={"div"} style={{ width: 30, height: 30, borderRadius: 15, background: G.mid }}/>
            <PvElement as={"div"} style={{ height: 11, width: 90, background: G.line, borderRadius: 5 }}/>
          </PvElement>
        </PvElement>
        <PvElement as={"div"} style={{ position: 'absolute', left: 2600, top: 275, opacity: contentOpacity }}>
