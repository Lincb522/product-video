...
export const LightLeakBurn: React.FC = () => {
    ...
    return (<PvElement as={AbsoluteFill} style={{ background: G.bg, overflow: 'hidden' }}>
      ...
      <PvElement as={AbsoluteFill} style={{ filter: pageFilter }}>
        {frame <= PEAK ? (<FakeDashboard variant="A"/>) : (<>
            <FakeDashboard variant="B"/>
            <PvElement as={"div"} style={{ position: 'absolute', left: 288, top: 132 }}>
      ...
      <PvElement as={AbsoluteFill} style={{ pointerEvents: 'none' }}>
        {blobs.map((b, i) => (<PvElement as={"div"} key={i} style={{
                position: 'absolute',
                left: cx + b.dx - b.d / 2,
                top: cy + b.dy - b.d / 2,
                width: b.d,
