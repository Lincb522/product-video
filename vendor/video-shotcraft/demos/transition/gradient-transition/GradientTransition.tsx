...
export const GradientTransition: React.FC = () => {
    ...
    return (<DesignStage bg="#0a0b10">
      {/* 三层渐变依次交叉淡入淡出 */}
      <PvElement as={"div"} style={layerStyle(bg1, 1 - seg(t, 0.3, 0.38))}/>
      <PvElement as={"div"} style={layerStyle(bg2, seg(t, 0.3, 0.38) - seg(t, 0.63, 0.71))}/>
      <PvElement as={"div"} style={layerStyle(bg3, seg(t, 0.63, 0.71))}/>
      {/* 中央 pill：标注当前渐变类型 */}
