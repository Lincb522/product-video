      ...
      <PvElement as={"div"} style={{
        ...
        <PvElement as={"div"} style={{
          ...
          <PvElement as={"div"} style={{
            ...
            <PvElement as={"div"} style={{ position: 'absolute', left: 250, top: 100 }}>
          ...
          <PvElement as={"div"} style={{
            ...
            <PvElement as={"div"} style={{ position: 'absolute', left: 150, top: 660 }}>
              <Card w={380} h={250} seed={71}/>
            </PvElement>
            <PvElement as={"div"} style={{ position: 'absolute', left: 1420, top: 160 }}>
        ...
        {/* 卡正面：放大初期渐隐，露出窗内新场景 */}
        <PvElement as={"div"} style={{ position: 'absolute', inset: 0, opacity: Math.max(0, 1 - t * 2.4) }}>
