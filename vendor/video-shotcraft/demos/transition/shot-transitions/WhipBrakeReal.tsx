...
const Scene: React.FC = () => {
    ...
    return (<PvElement as={AbsoluteFill} style={{ backgroundColor: '#f9f6f1', overflow: 'hidden' }}>
      <PvElement as={"div"} style={{ position: 'absolute', top: 340, transform: `translateX(${-dx}px)` }}>
        {RAIL.map((c, k) => (<PvElement as={Img} key={c.file + k} src={staticFile(`textures/live/${c.file}`)} style={{
