...
export const BarnDoorSplit: React.FC = () => {
    ...
    return (<PvElement as={"div"} style={{
      ...
      <PvElement as={"div"} style={{
        ...
        <PvElement as={"div"} style={{ position: 'absolute', left: 0, top: 0, width: 1920, height: 1080 }}>
          <FakeDashboard variant="A"/>
        </PvElement>
        {tornEdge && <PvElement as={"div"} style={edgeLine('right')}/>}
      </PvElement>
      ...
      <PvElement as={"div"} style={{
        ...
        {tornEdge && <PvElement as={"div"} style={edgeLine('left')}/>}
      </PvElement>

      {/* 裂点预告：中缝 2px 细线闪现两次 */}
      {crackFlash && (<PvElement as={"div"} style={{
                position: 'absolute',
                left: 959,
                top: 0,
                width: 2,
