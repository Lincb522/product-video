...
const Face: React.FC<{
...
}> = ({ variant, rot, brightness, seam, seamSide }) => (<PvElement as={"div"} style={{
        position: 'absolute',
        width: W,
        height: H,
        overflow: 'hidden',
    ...
    <PvElement as={"div"} style={{ transform: `scale(${S})`, transformOrigin: '0 0' }}>
      <FakeDashboard variant={variant}/>
    </PvElement>
    {seam > 0.01 && (<PvElement as={"div"} style={{
            position: 'absolute',
            top: 0,
            [seamSide]: 0,
            width: 150,
...
export const CubeRotate: React.FC = () => {
    ...
    return (<PvElement as={"div"} style={{ width: 1920, height: 1080, background: G.bg, position: 'relative', overflow: 'hidden' }}>
      ...
      <PvElement as={"div"} style={{ position: 'absolute', left: 120, top: 60 }}>
