...
export const WhiteFlashLogoSimplifyCut: React.FC = () => {
    ...
    return (<DesignStage bg="#08070c">
      <PvElement as={"div"} style={{ position: 'absolute', inset: 0, background: '#08070c', overflow: 'hidden' }}>
        {/* 彩色液态词层 */}
        ...
        {/* 白色全屏层：easeIn 冲入后保持 */}
        <PvElement as={"div"} style={{ position: 'absolute', inset: 0, background: '#fff', opacity: flashK }}/>
