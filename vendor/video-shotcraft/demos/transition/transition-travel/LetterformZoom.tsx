...
export const LetterformZoom: React.FC = () => {
    ...
    return (<PvElement as={AbsoluteFill} style={{ background: G.bg, overflow: 'hidden' }}>
      ...
      {plateOpacity > 0 && (<PvElement as={"div"} style={{
                position: 'absolute',
                inset: 0,
          ...
          <PvElement as={"svg"} width={1920} height={1080} viewBox="0 0 1920 1080" style={{ position: 'absolute', inset: 0, display: 'block' }}>
            <PvElement as={"defs"}>
              <PvElement as={"mask"} id={cutId}>
                <PvElement as={"rect"} width={1920} height={1080} fill="#fff"/>
                <PvElement as={"text"} x={960} y={BASELINE} textAnchor="middle" fill="#000" style={titleFont}>
                  DASH
                </PvElement>
              </PvElement>
            </PvElement>
            <PvElement as={"rect"} width={1920} height={1080} fill={G.bg} mask={`url(#${cutId})`}/>
            {/* 字缘细描边：让"洞"的轮廓在米灰上读得清 */}
            <PvElement as={"text"} x={960} y={BASELINE} textAnchor="middle" fill="none" stroke={G.ink} strokeWidth={3} opacity={0.3} style={titleFont}>
              DASH
            </PvElement>
          </PvElement>
          ...
          <PvElement as={"div"} style={{
            ...
            <PvElement as={"div"} style={{ width: 240, height: 16, background: G.bar, borderRadius: 8 }}/>
            <PvElement as={"div"} style={{ width: 130, height: 16, background: G.line, borderRadius: 8 }}/>
          </PvElement>
        </PvElement>)}
    </PvElement>);
};
