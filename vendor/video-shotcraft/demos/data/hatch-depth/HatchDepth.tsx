    ...
    return (<DesignStage bg="#0a0a0c">
      <PvElement as={"div"} style={{
        ...
        {ROWS.map(({ label, w }, i) => {
            ...
            return (<PvElement as={"div"} key={i} style={{ display: 'flex', alignItems: 'center', gap: 14, height: 26 }}>
              ...
              <PvElement as={"div"} style={{ position: 'relative', height: '100%', flex: 1 }}>
                {/* 斜纹占位层 */}
                <PvElement as={"div"} style={{
                    position: 'absolute',
                    left: 0,
        ...
        <PvElement as={"div"} style={{
          ...
          <PvElement as={"span"} style={{ color: '#e8eaf0', fontWeight: 700 }}>METRICS</PvElement>
          {NBSP2}
          <PvElement as={"span"} style={{ color: '#67d17c' }}>● LIVE</PvElement>
          {NBSP2}
          <PvElement as={"span"} style={{ color: '#8b91a3' }}>TOTAL 875K{NBSP2}AVG 1.02M</PvElement>
        </PvElement>
      </PvElement>
    </DesignStage>);
};
