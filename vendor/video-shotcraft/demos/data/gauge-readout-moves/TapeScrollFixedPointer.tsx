...
export const TapeScrollFixedPointer: React.FC = () => {
    ...
    return (<PvElement as={"div"} style={{ width: 1920, height: 1080, background: G.bg, position: 'relative', overflow: 'hidden' }}>
      ...
      <PvElement as={"div"} style={{
        ...
        <PvElement as={"div"} style={{ position: 'absolute', inset: 0 }}>{
        // 内层坐标 = 屏幕 y - 180
        <PvElement as={"div"} style={{ position: 'absolute', left: 0, right: 14, top: -180, height: 1080 + 400 }}>
            {ticks}
          </PvElement>}</PvElement>
      </PvElement>
      ...
      <PvElement as={"svg"} width={60} height={64} style={{ position: 'absolute', left: TAPE_X - 66, top: CENTER_Y - 32 }}>
        <PvElement as={"polygon"} points="4,4 56,32 4,60" fill={AMBER}/>
      </PvElement>
      ...
      <PvElement as={"div"} style={{
        ...
        <PvElement as={"div"} style={{ height: 12, width: 150, background: G.line, borderRadius: 6, marginBottom: 12 }}/>
        <PvElement as={"div"} style={{ fontFamily: 'Helvetica, Arial, sans-serif', fontWeight: 800, fontSize: 96, color: AMBER, letterSpacing: -2, lineHeight: 1 }}>
          {Math.round(v)}
        </PvElement>
      </PvElement>
    </PvElement>);
