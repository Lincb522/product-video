...
export const CounterConfetti: React.FC = () => {
    ...
    return (<DesignStage bg="radial-gradient(80% 80% at 50% 45%,#161a2b,#07080e 75%)">
      {/* 中心辉光 */}
      ...
      <PvElement as={"div"} style={{ position: 'absolute', left: '50%', top: '47%', transformOrigin: '50% 50%', transform: `scale(${sc})` }}>
        <PvElement as={"div"} style={{
            position: 'absolute',
            left: 0,
            top: 0,
