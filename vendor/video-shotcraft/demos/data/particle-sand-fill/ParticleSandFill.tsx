...
export const ParticleSandFill: React.FC = () => {
    ...
    return (<PvElement as={"div"} style={{ width: 1920, height: 1080, background: G.bg, position: 'relative', overflow: 'hidden' }}>
      ...
      <PvElement as={"div"} style={{
        ...
        <PvElement as={"div"} style={{ height: 14, width: 260, background: G.bar, borderRadius: 7 }}/>
        <PvElement as={"div"} style={{ height: 10, width: 160, background: G.line, borderRadius: 5, marginTop: 10 }}/>
      </PvElement>
      {/* 基线 */}
      <PvElement as={"div"} style={{ position: 'absolute', left: CARD.x + 40, top: PLOT_BOTTOM, width: CARD.w - 80, height: 3, background: G.line }}/>
      ...
      {BARS.map((bar, b) => {
            ...
            {solidOp > 0 && (<PvElement as={"div"} style={{
            ...
            {labelScale > 0 && (<PvElement as={"div"} style={{
            ...
            {solidOp < 1 && Array.from(pvArrayCopy({ length: bar.n })).map((_, i) => {
