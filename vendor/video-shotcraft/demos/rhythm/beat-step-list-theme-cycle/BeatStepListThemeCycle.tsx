...
export const BeatStepListThemeCycle: React.FC = () => {
    ...
    return (<PvElement as={AbsoluteFill} style={{ background: bgColor, fontFamily: FONT, justifyContent: 'center' }}>
      ...
      {/* 视口上下羽化 */}
      <PvElement as={"div"} style={{ position: 'absolute', left: 0, right: 0, top: 0, height: 300, background: `linear-gradient(${bgColor}, transparent)`, zIndex: 3 }}/>
      <PvElement as={"div"} style={{ position: 'absolute', left: 0, right: 0, bottom: 0, height: 300, background: `linear-gradient(transparent, ${bgColor})`, zIndex: 3 }}/>
    </PvElement>);
};
