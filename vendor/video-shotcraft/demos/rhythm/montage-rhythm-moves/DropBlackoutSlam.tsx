...
export const DropBlackoutSlam: React.FC = () => {
    ...
    if (f < BLACK_IN) {
        ...
        <PvElement as={"div"} style={{ width: 1920, height: 1080, transform: `scale(${breathe})`, transformOrigin: '50% 50%' }}>
    ...
    if (f < SLAM) {
        return <PvElement as={"div"} style={{ width: 1920, height: 1080, background: '#0c0c0c' }}/>;
    }
    // ===== 段 3:帧 62 起爆入 =====
    const t = f - SLAM;
